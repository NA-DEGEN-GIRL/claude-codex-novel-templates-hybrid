...
>
> **Phase 1 diet (2026-04-17)**: 집필 전 메모 8개 → 3개, Drafting Surface 11개 → 4원칙, 자기점검 10개 → 3개로 압축. 자세한 근거와 롤백: `docs/updates/phase-1-hot-path.md`.
...
5. 직전 화 마지막 장면 — 마지막 장면 전체 또는 마지막 8~12문단 (최소 2~3문단). auto-compact 여부와 무관.
...
1. **선명도 우선**: 잘 쓰려 하기보다 **잘 읽히게**. 누가 무엇을 보고, 어떻게 판단하고, 무엇이 바뀌는지가 문장에서 바로 읽혀야. 첫 문장과 전투/위기 장면에서 특히.
