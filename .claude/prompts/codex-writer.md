...
> **🏷️ 모드 라벨 (Phase 3 role consolidation, 2026-04-17)**: 이 파일은 `writer_model: codex` 전용. `writer_model: claude`에는 `claude-writer.md`를 사용. supervisor가 잘못 선택하면 tmux 세션 제어 명령(Enter 타이밍, sentinel 매칭)이 어긋나 runtime 실패.
>
